...
trees: clean
	...
	$(CXX) $(CXXFLAGS) $(TARGET) -DINMEMORY -DBENCHMARK -DLOL_FAT -DVARIABLE_SPLIT -DDOUBLE_IQR -DREDISTRIBUTE -DLOL_RESET -o $(EXE_DIR)/8_quit
	...
	$(CXX) $(CXXFLAGS) $(TARGET) -DINMEMORY -DBENCHMARK -DLOL_FAT -DVARIABLE_SPLIT -DDOUBLE_IQR -DREDISTRIBUTE -DLOL_RESET=0 -O3 -o $(EXE_DIR)/O3_8_quit
